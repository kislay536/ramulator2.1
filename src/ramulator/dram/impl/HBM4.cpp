...
class HBM4 : public DRAMSpec {
 public:
  ...
  using CommandImpls = std::tuple<
      Cmd::ACT<HBM4>, Cmd::PREpb<HBM4>, Cmd::PREab<HBM4>, Cmd::RD<HBM4>, Cmd::WR<HBM4>, Cmd::RDA<HBM4>,
...
// Self-registration
static bool _dram_hbm4 = DRAMSpec::register_standard(
    "HBM4", [](const ConfigNode& config) { return std::make_unique<HBM4>(config); });
